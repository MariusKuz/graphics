...
{	
    ...
    protected void renderScene()
    {
        ...
        GL11.glPushMatrix();
        {
	        ...
	        drawUnitCube(Colour.WHITE,Colour.WHITE,Colour.RED,Colour.RED,Colour.GREEN,Colour.GREEN);
        }
        GL11.glPopMatrix();
        ...
        GL11.glPushMatrix();
        {
	        ...
	        drawUnitCube(Colour.ORANGE,Colour.ORANGE,Colour.RED,Colour.RED,Colour.GREEN,Colour.GREEN);
        }
        GL11.glPopMatrix();
        ...
        GL11.glPushMatrix();
        {
        	...
        	//GL11.glPolygonMode(GL11.GL_FRONT_AND_BACK, GL11.GL_LINE);
	        GL11.glTranslatef(0.0f, 1.0f, -6.0f);
	        drawUnitCube(Colour.PINK,Colour.PINK,Colour.RED,Colour.RED,Colour.GREEN,Colour.GREEN);
