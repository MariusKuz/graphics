...
public class Lab3 extends GraphicsLab
{
    ...
    protected void initScene()
    {
        ...
        {   drawUnitCube(Colour.RED,Colour.RED,Colour.BLUE,Colour.BLUE,Colour.GREEN,Colour.GREEN);
        	//drawUnitRoof(Colour.RED,Colour.RED,Colour.BLUE,Colour.BLUE,Colour.GREEN);
    ...
    protected void drawUnitRoof(Colour near, Colour far, Colour left, Colour right, Colour bottom)
    {
    	Vertex v1 = new Vertex(-0.5f, 0.5f,  0.5f);
        Vertex v2 = new Vertex( 0.5f, 0.5f,  0.5f);
        Vertex v3 = new Vertex( 1f,  1.5f,  0.5f);
        
        
        Vertex v4 = new Vertex(-0.5f, 0.5f, -0.5f);
        Vertex v5 = new Vertex(0f,  1.5f, -0.5f);
        Vertex v6 = new Vertex( 0.5f, 0.5f, -0.5f);
        
        
        GL11.glBegin(GL11.GL_POLYGON); //near face
        near.submit();
        v3.submit();
        v1.submit();
        v2.submit();
       ...
       GL11.glBegin(GL11.GL_POLYGON);//far face
       far.submit();
        v5.submit();
        v6.submit();
        v4.submit();
        ...
        GL11.glBegin(GL11.GL_POLYGON); //right face
        right.submit();
        v5.submit();
        v3.submit();
        v2.submit();
        ...
        GL11.glBegin(GL11.GL_POLYGON); //left face
        left.submit();
        v3.submit();
        v5.submit();
        v4.submit();
        ...
        GL11.glBegin(GL11.GL_POLYGON); //bottom face
        bottom.submit();
        v2.submit();
        v1.submit();
        v4.submit();
