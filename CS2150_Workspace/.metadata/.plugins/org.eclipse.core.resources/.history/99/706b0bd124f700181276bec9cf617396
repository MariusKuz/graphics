 ...
 *  Scene origin
 *  |
 *  +-- [S(25f,1f,20f) T(0f,groundPlaneY,-10f)] Ground plane
 *  |
 *  +-- [S(25f,1f,10f) Rx(90f) T(0f,backPlaneY,-20f)] Sky plane
 *  |
 *  +-- [S(25f,10f,19f) Rx(90f) T(0f,spacePlaneY,-20f)] Space Plane
 *  | 
 *  +-- [S(rocketScale, rocketScale, rocketScale) Rx(-90f) T(0.0f, -0.65f, -10f)]  Rocket Base
 *  |   |
 *  |   +--[S(rocketScale, rocketScale, rocketScale) Rx(90) T(0.0f, 3.0f, 0.0f)] Rocket Nose
 *  |   |
 *  |   +-- (finScaling, finScaling, finScaling) T(translationFrontFin, translationYFinCord, -10.0f)]Rocket Fin (right)
 *  |   |
 *  |   +-- [S(finScaling, finScaling, finScaling) Ry(180f) T(translationRightFin + 2.0f), translationYFinCord, -10.0f)] Rocket Fin (left)
 *  |   |
 *  |   +-- [S(finScaling, finScaling, finScaling) Ry(-90f) T(0f, translationYFinCord, translationBackFin)]Rocket Fin (front)
 *  |   |
 *  |   +-- [S(finScaling, finScaling, finScaling) Ry(90f) T(0.0f, -0.3f, translationLeftFin)] Rocket Fin (back)
 *  |
 *  +-- [S(1.2f, 1.2f, 1.2f) Ry(35f) T(2.75f, launcherYCorrd, -12f)] Rocket Launcher
 *  |
 *  +-- [Ry(360.0f * marsPosition / 300.0f) T(8.0f, sphereYCoord, 0.0f)] Mars
 *  	|
 *  	+-- [Ryz(360.0f * marsPosition * 0.009f) T(0.5f, 0.0f, 0.0f)] Mars Moon 1
 *  	|
 *  	+-- [Ryz(360.0f * marsPosition * 0.009f) T(0.8f, 0.0f, 0.0f)] Mars Moon 2
